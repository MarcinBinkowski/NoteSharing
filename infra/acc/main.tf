...
variable "project_id" {
  description = "GCP project ID for acc"
  type        = string
}
...
output "cloud_run_url" {
  description = "Acceptance Cloud Run URL"
  value       = module.environment.cloud_run_url
}

output "service_account_email" {
  description = "Acceptance Cloud Run service account"
  value       = module.environment.service_account_email
}


output "mapped_domain" {
  description = "Acceptance mapped custom domain"
